...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 444.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 374.0, 444.0, 29.5, 22.0 ],
					"text" : "*~"
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 492.0, 173.0, 443.0, 236.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ],
					"waveformdisplay" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 31.0, 676.0, 148.0, 22.0 ],
					"text" : "pfft~ FFT-Processor 512 4"
				}
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Projects/VocalManipulation/VocalManipulation/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
